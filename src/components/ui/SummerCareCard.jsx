...
const SummerCareCard = () => {
  const hydrationData = {
    ...
    return (
        <div className='border p-3 bg-gradient-to-r from-blue-100 to-blue-300 rounded-xl animate__animated animate__fadeInUp animate__slow'>
            <h1 className='text-center text-xl font-semibold text-gray-800 ' >{hydrationData.title}</h1>
            <div className='grid grid-cols-2 gap-x-2'>
                {hydrationData.tips.map((tip, index) =>{
                    return (
